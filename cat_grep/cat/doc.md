...
flags |= FLAG_B;  // Установка флага FLAG_B
```
...
flags = 0000 0001
FLAG_B = 0000 0001
flags & FLAG_B  ->  0000 0001 (ненулевое значение, флаг установлен)
```
...
```C
flags &= ~FLAG_B;  // Сьрасывает флаг FLAG_B
```
